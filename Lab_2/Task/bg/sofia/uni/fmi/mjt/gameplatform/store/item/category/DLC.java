...
public class DLC implements StoreItem{
    ...
    public Game getGame() {
        return new Game(game.getTitle(),game.getPrice(),game.getReleaseDate(),game.getGenre());
    }

    public void setGame(Game game) {
        this.game = new Game(game.getTitle(),game.getPrice(),game.getReleaseDate(),game.getGenre());
    }
